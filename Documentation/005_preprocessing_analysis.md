# Documentation: 005_simulate_demand_factors.ipynb

This document outlines the end-to-end data processing, simulation, and feature engineering pipeline executed in the `005_simulate_demand_factors.ipynb` notebook. The primary goal of this notebook is to clean external macroeconomic factors, inject realistic retail patterns into the sales data, and prepare time-series features for future forecasting models.
