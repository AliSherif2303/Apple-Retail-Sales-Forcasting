...
**Notebook:** `notebooks/001_data_loading_and_merging.ipynb`
...
**Notebook:** `notebooks/005_simulate_demand_factors.ipynb`
...
**Notebook:** `notebooks/005_simulate_demand_factors.ipynb` (Cell 31+)
...
**Script:** `scripts/fix_simulation_factors.py`
...
**Notebooks:** `012_catboost_with_baselines.ipynb`, `011_catboost_forecasting.ipynb`
...
**Notebooks:** `011_catboost_forecasting.ipynb`, `012_catboost_with_baselines.ipynb`
